...
public class UserRoleController
{
    ...
    @PutMapping(value = "/rolesUsers/{iduser_role}")
    public ResponseEntity<UserRole> updateUserRole(@PathVariable Long iduser_role, @Valid @RequestBody UserRole updatedUserRole)
    {
        return ResponseEntity.ok(userRoleService.updateUserRoleById(iduser_role, updatedUserRole));
    }
