...
public class UserController
{
    ...
    @GetMapping(value = "/FindUser/{firstName}/{lastName}")
    public ResponseEntity<List<User>> findByName(@PathVariable String firstName, @PathVariable String lastName)
    {
        return ResponseEntity.ok(userService.getUserByName(firstName, lastName));
    }
}
